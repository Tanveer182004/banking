...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(label_1.Label, __assign({ ref: ref, className: utils_1.cn(error && "text-destructive", className), htmlFor: formItemId }, props)));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formDescriptionId, className: utils_1.cn("text-sm text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formMessageId, className: utils_1.cn("text-sm font-medium text-destructive", className) }, props), body));
});
