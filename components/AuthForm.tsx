              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                {type === 'sign-up' && (
                  ...
                  <div className="flex gap-4">
                    ...
                    <CustomInput
                      control={form.control} name='city' label="City" placeholder="Eg: Mumbai"
                    />

                    <div className="flex gap-4">
                    <CustomInput
                      control={form.control} name='state' label="State" placeholder="Eg: Maharashtra"
                    />

                    <CustomInput
                      control={form.control} name='postalCode' label="Postal Code" placeholder="Eg: 40001"
                    />
                    </div>
                    ...
                    <CustomInput
                      control={form.control} name='ssn' label="SSN" placeholder="Eg: 1234"
                    />
                    </div>
                  </>
                )}
